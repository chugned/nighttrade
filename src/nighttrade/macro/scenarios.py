...
SCENARIOS: "dict[str, MacroScenario]" = {
    ...
    "fed_dovish": MacroScenario(
        label="fed_dovish", bias=Bias.BULLISH, score=0.62, confidence=0.80,
        risk_level=RiskLevel.LOW,
    ...
    "fed_hawkish": MacroScenario(
        label="fed_hawkish", bias=Bias.BEARISH, score=-0.45, confidence=0.72,
        risk_level=RiskLevel.MEDIUM,
    ...
    "credit_crisis": MacroScenario(
        label="credit_crisis", bias=Bias.BEARISH, score=-0.95,
