...
class PriceTick(NighttradeModel):
...
class ConsensusPrice(NighttradeModel):
...
class OrderBookLevel(NighttradeModel):
...
class OrderBookSnapshot(NighttradeModel):
