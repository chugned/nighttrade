...
from ._base import NighttradeModel, normalize_timestamp


class BacktestMetrics(NighttradeModel):
...
class WalkForwardFold(NighttradeModel):
...
class WalkForwardReport(NighttradeModel):
    ...
    model_config = NighttradeModel.model_config | {"protected_namespaces": ()}
