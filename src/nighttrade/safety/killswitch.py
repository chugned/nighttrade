...
* **Macro kill switch** — systemic danger: war, credit crisis, market panic,
  or any macro read at/above the configured risk ceiling.
* **Micro kill switch** — local market hazards: chop zones, thin participation,
  trading halts, and extreme spreads that would make any fill a bad fill.
"""
...
_CRITICAL_REGIMES = {"war", "credit_crisis", "panic"}
