...
from nighttrade.config import KillSwitchConfig
...
from nighttrade.safety import evaluate_kill_switch
...
def test_macro_kill_on_credit_crisis():
    result = evaluate_kill_switch(_macro("credit_crisis"), _micro(), CFG)
