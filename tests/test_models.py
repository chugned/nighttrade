...
from nighttrade.models._base import normalize_timestamp
...
def test_pricetick_symbol_uppercased():
    tick = PriceTick(symbol="aapl", exchange="nasdaq", price=1.0, timestamp=0)
    assert tick.symbol == "AAPL" and tick.exchange == "NASDAQ"
